# Ministry of Justice (وزارة العدل) — Real Estate Data

## Overview

**Source:** Saudi National Open Data Platform (open.data.gov.sa)
**Publisher:** Ministry of Justice (وزارة العدل) — Organization ID: `35c63412-c4ae-4303-8fef-56cfd71303cf`
...
3 datasets had broken resources API responses (returned empty JSON). We recovered 4 of 5 missing files by constructing download URLs from sibling patterns:
...
| **Property-Identity Q2 2025** | **File never uploaded** | **Genuinely missing — empty downloadUrl, 0-byte file on server** |
